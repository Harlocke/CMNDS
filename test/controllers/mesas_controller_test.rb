...
class MesasControllerTest < ActionController::TestCase
  ...
  test "should create mesa" do
    assert_difference('Mesa.count') do
      post :create, mesa: { descripcion: @mesa.descripcion, estado: @mesa.estado, nombre: @mesa.nombre }
    end
  ...
  test "should update mesa" do
    patch :update, id: @mesa, mesa: { descripcion: @mesa.descripcion, estado: @mesa.estado, nombre: @mesa.nombre }
    assert_redirected_to mesa_path(assigns(:mesa))
  end
